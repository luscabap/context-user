...
export const useCarrinhoContext = () => {
    ...
    useEffect(() => {
        const { novaQuantidade, novoTotal } = carrinho.reduce((cont, produto) => ({ 
            novaQuantidade: cont.novaQuantidade + produto.quantidade,
            novoTotal: cont.novoTotal + (produto.valor * produto.quantidade)
         }), {
            novaQuantidade: 0,
            novoTotal: 0
        });
